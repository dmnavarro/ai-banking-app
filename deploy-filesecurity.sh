...
echo ""
echo " 2. Add FILESCAN_BUCKET as a GitHub Actions secret:"
echo "    FILESCAN_BUCKET = $SCANNING_BUCKET"
echo "    (the CI pipeline will inject it as an env var on ECS)"
echo ""
echo " 3. Redeploy ECS to pick up the env var:"
echo "    ./deploy-ecs.sh --github-org <your-github-org> --skip-oidc"
echo ""
echo "════════════════════════════════════════════════════════"
